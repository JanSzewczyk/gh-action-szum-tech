...
describe("Github Message Builder > Builders > Common", () => {
  test("buildCodeBlock function, should return a built code style", () => {
    const someObject = {
      field: "aaa",
      field2: "bbb"
    };
